...
export class PriceListDto {
  ...
  infantPassengerCount: string;
  infantNetPrice: string;
  infantTax: string;
  infantServiceFee: string;
  infantMinServiceFee: string;
  infantCompanyCardRequired: string;
  ...
  constructor(priceList: PlanePrices) {
    ...
    this.infantPassengerCount = priceList.BebekYolcuSayisi;
    this.infantNetPrice = priceList.BebekNetFiyat;
    this.infantTax = priceList.BebekVergi;
    this.infantServiceFee = priceList.BebekServisUcret;
    this.infantMinServiceFee = priceList.BebekMinServisUcret;
    this.infantCompanyCardRequired = priceList.BebekFirmaKartZorunluMu;
