export const ObjectTyped = {
   ...
   */
  keys: Object.keys as <T extends object>(yourObject: T) => Array<keyof T>,
  /**
  ...
  values: Object.values as <U extends object>(
    yourObject: U,
  ) => Array<U[keyof U]>, // Using ValueOf here was giving weird hover annotation: ValueOf<{ ...the whole damn object... }> as opposed to ['key1', 'key2', etc]
  /**
