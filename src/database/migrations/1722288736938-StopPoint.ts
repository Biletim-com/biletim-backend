...
export class StopPoint1722288736938 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "stop_points"`);
  }
}
