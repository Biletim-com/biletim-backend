...
export default registerAs(
  ...
  (): TPaymentConfiguration => ({
    ...
    garantiVPosBaseUrl: process.env.GARANTI_VPOS_BASE_URI,
    garantiSwitchId: process.env.GARANTI_SWITCH_ID,
    garantiSwitchPassword: process.env.GARANTI_SWITCH_PASSWORD,
  }),
);
