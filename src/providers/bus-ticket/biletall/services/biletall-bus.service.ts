...
import { BiletAllBusParserService } from '../parsers/biletall-bus-parser.service';

// dtos
import {
  BusCompanyDto,
  BusCompanyRequestDto,
} from '@app/modules/tickets/bus/dto/bus-company.dto';
import {
  BusScheduleListResponseDto,
  BusScheduleRequestDto,
} from '@app/modules/tickets/bus/dto/bus-schedule-list.dto';
import {
  BusTicketDetailDto,
  BusTicketDetailRequestDto,
} from '@app/modules/tickets/bus/dto/bus-ticket-detail.dto';
import {
  BoardingPointDto,
  BoardingPointRequestDto,
} from '@app/modules/tickets/bus/dto/bus-boarding-point.dto';
import {
  ServiceInformationDto,
  ServiceInformationRequestDto,
} from '@app/modules/tickets/bus/dto/bus-service-information.dto';
...
} from '@app/modules/tickets/bus/dto/bus-seat-availability.dto';
