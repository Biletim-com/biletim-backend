...
export class HotelBooking1734288602665 implements MigrationInterface {
  name = 'HotelBooking1734288602665';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE SEQUENCE "reservation_number_seq" START WITH 1000 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "hotel_booking_orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_email" character varying NOT NULL, "user_phone_number" character varying NOT NULL, "status" character varying NOT NULL, "type" character varying NOT NULL, "upsell" jsonb NOT NULL, "payment_type" jsonb NOT NULL, "reservation_number" bigint NOT NULL DEFAULT nextval('reservation_number_seq'), "user_id" uuid, "transaction_id" uuid, "invoice_id" uuid, CONSTRAINT "UQ_b8d7414b6181121ecb67a93cac0" UNIQUE ("reservation_number"), CONSTRAINT "REL_7892a596e38516f69906f98ae2" UNIQUE ("transaction_id"), CONSTRAINT "REL_2e0fb39c9fb7e54b510d0210e7" UNIQUE ("invoice_id"), CONSTRAINT "PK_17d3f1fd4fc367e2a8963c8a1b3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP SEQUENCE "reservation_number_seq"`);
  }
}
