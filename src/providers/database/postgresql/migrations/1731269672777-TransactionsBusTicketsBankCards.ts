...
export class TransactionsBusTicketsBankCards1731269672777 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "passengers" DROP COLUMN "middle_name"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "middle_name"`);
        await queryRunner.query(`ALTER TABLE "passports" DROP COLUMN "expiration_date"`);
        await queryRunner.query(`ALTER TABLE "passports" ADD "expiration_date" date NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "bank_cards" ADD CONSTRAINT "FK_0859655a741507c10976af1c09c" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "bus_tickets" ADD CONSTRAINT "FK_4be2d07e3559d0340fe934f24b5" FOREIGN KEY ("departure_terminal_id") REFERENCES "bus_terminals"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bus_tickets" ADD CONSTRAINT "FK_cbd3a182332e8a79e4f7e5b5620" FOREIGN KEY ("arrival_terminal_id") REFERENCES "bus_terminals"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bus_tickets" ADD CONSTRAINT "FK_61d3d48a248ee7d50ee85326a0d" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_a922b820eeef29ac1c6800e826a" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_4547f22852bd9778b54dafe30e5" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "FK_f2270bbc11d52b77cad5469f534" FOREIGN KEY ("bank_card_id") REFERENCES "bank_cards"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_f2270bbc11d52b77cad5469f534"`);
        await queryRunner.query(`ALTER TABLE "orders" DROP CONSTRAINT "FK_4547f22852bd9778b54dafe30e5"`);
        await queryRunner.query(`ALTER TABLE "orders" DROP CONSTRAINT "FK_a922b820eeef29ac1c6800e826a"`);
        await queryRunner.query(`ALTER TABLE "bus_tickets" DROP CONSTRAINT "FK_61d3d48a248ee7d50ee85326a0d"`);
        await queryRunner.query(`ALTER TABLE "bus_tickets" DROP CONSTRAINT "FK_cbd3a182332e8a79e4f7e5b5620"`);
        await queryRunner.query(`ALTER TABLE "bus_tickets" DROP CONSTRAINT "FK_4be2d07e3559d0340fe934f24b5"`);
        await queryRunner.query(`ALTER TABLE "wallets" DROP CONSTRAINT "FK_92558c08091598f7a4439586cda"`);
        await queryRunner.query(`ALTER TABLE "bank_cards" DROP CONSTRAINT "FK_0859655a741507c10976af1c09c"`);
        await queryRunner.query(`ALTER TABLE "passengers" DROP COLUMN "birthday"`);
        await queryRunner.query(`ALTER TABLE "passengers" ADD "birthday" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "passports" DROP COLUMN "expiration_date"`);
        await queryRunner.query(`ALTER TABLE "passports" ADD "expiration_date" TIMESTAMP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "users" ADD "middle_name" character varying`);
        await queryRunner.query(`ALTER TABLE "passengers" ADD "middle_name" character varying`);
        await queryRunner.query(`ALTER TABLE "passengers" ADD "email" character varying`);
        await queryRunner.query(`ALTER TABLE "passengers" ADD "phone" character varying`);
