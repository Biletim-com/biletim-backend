  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "credit_cards" ADD CONSTRAINT "FK_9b45d5bea143bd999722d512195" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "credit_cards" DROP CONSTRAINT "FK_9b45d5bea143bd999722d512195"`,
    );
    await queryRunner.query(`ALTER TABLE "passengers" DROP COLUMN "birthday"`);
    await queryRunner.query(
